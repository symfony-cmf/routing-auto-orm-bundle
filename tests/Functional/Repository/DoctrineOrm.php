...
use Symfony\Cmf\Bundle\RoutingAutoOrmBundle\Tests\Fixtures\App\Entity\BlogNoTranslatable;
use Symfony\Cmf\Bundle\RoutingAutoOrmBundle\Tests\Fixtures\App\Entity\Post;
use Symfony\Cmf\Bundle\RoutingAutoOrmBundle\Tests\Fixtures\App\Entity\PostNoTranslatable;
...
class DoctrineOrm
{
    ...
    public function findBlog($blogName)
    {
        ...
        $query = $objectManager->createQuery("
            SELECT b FROM Symfony\Cmf\Bundle\RoutingAutoOrmBundle\Tests\Fixtures\App\Entity\Blog b 
            INNER JOIN Symfony\Cmf\Bundle\RoutingAutoOrmBundle\Tests\Fixtures\App\Entity\BlogTranslation bt
    ...
    public function findPost($title)
    {
        $objectManager = $this->getObjectManager();
        $query = $objectManager->createQuery("
            SELECT p FROM Symfony\Cmf\Bundle\RoutingAutoOrmBundle\Tests\Fixtures\App\Entity\Post p 
            INNER JOIN Symfony\Cmf\Bundle\RoutingAutoOrmBundle\Tests\Fixtures\App\Entity\PostTranslation pt
    ...
    public function findArticle($title, $locale)
    {
        $objectManager = $this->getObjectManager();
        $query = $objectManager->createQuery("
            SELECT a FROM Symfony\Cmf\Bundle\RoutingAutoOrmBundle\Tests\Fixtures\App\Entity\Article a 
            INNER JOIN Symfony\Cmf\Bundle\RoutingAutoOrmBundle\Tests\Fixtures\App\Entity\ArticleTranslation at
